package pw.choochoo.cli;

import pw.choochoo.ChooChooConfiguration;
...
public class RenderCommand extends ConfiguredCommand<ChooChooConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<ChooChooConfiguration> bootstrap,
                       Namespace namespace,
                       ChooChooConfiguration configuration) throws Exception {
